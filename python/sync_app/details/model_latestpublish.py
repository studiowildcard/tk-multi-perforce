...
class SgLatestPublishModel(ShotgunModel):
    ...
    def _populate_thumbnail_image(self, item, field, image, path):
        ...
        if is_folder:
            ...
            thumb = loader_utils.create_overlayed_folder_thumbnail(image)
        else:
            thumb = loader_utils.create_overlayed_publish_thumbnail(image)
    ...
    def _before_data_processing(self, sg_data_list):
        ...
        # of publishes:
        sg_data_list = loader_utils.filter_publishes(app, sg_data_list)
